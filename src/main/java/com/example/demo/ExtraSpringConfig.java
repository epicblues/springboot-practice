...
public class ExtraSpringConfig {
    ...
    public DataSource rdbDataSource() throws ClassNotFoundException {
        ...
        Class<? extends DataSource> dataSourceSubType = Class.forName("com.mysql.cj.jdbc.MysqlDataSource").asSubclass(DataSource.class);


        return DataSourceBuilder.create()
                // DataSource의 하위 타입만 매개변수로 받는다.
                .type(dataSourceSubType)
                .url("jdbc:mysql://localhost:3306/remember_me")
